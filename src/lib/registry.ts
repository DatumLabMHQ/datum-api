...
export const RESOURCES: Resource[] = [
  ...
  { product: 'morpho', name: 'positions', table: 'morpho.fct_morpho_position_daily', description: 'The largest suppliers and borrowers of the largest listed markets per day (a sample taken twice a day): value, collateral, health factor and share of the market at the snapshot.', grain: 'chain × market × side × user × day', dayColumn: 'day', timeColumn: null, filters: { day: 'date', chain_id: 'int', market_id: 'text', side: 'text', user_address: 'text' }, order: 'day desc, side, rank' },
  { product: 'morpho', name: 'health', table: 'morpho.fct_morpho_market_health_daily', description: 'Per sampled market per day: the largest borrowers\' collateral by health-factor band, how much of the market\'s borrow and supply the sample covers, and the top-5 supplier share.', grain: 'chain × market × day', dayColumn: 'day', timeColumn: null, filters: { day: 'date', chain_id: 'int', market_id: 'text' }, order: 'day desc, market_borrow_usd desc nulls last' },
